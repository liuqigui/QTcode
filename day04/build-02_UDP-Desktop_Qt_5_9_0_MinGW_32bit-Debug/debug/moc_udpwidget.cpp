...
QT_MOC_LITERAL(1, 10, 21), // "on_buttonSend_clicked"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "UDPWidget\0on_buttonSend_clicked\0"
};
...
void UDPWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UDPWidget *_t = static_cast<UDPWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject UDPWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UDPWidget.data,
      qt_meta_data_UDPWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *UDPWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UDPWidget.stringdata0))
        return static_cast<void*>(const_cast< UDPWidget*>(this));
